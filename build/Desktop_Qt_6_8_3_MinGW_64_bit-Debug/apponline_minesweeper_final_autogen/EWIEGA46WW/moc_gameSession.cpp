...
static constexpr auto qt_meta_stringdata_ZN11GameSessionE = QtMocHelpers::stringData(
    "GameSession"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11GameSessionE[] = {
...
Q_CONSTINIT const QMetaObject GameSession::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11GameSessionE.offsetsAndSizes,
    qt_meta_data_ZN11GameSessionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11GameSessionE_t,
        // Q_OBJECT / Q_GADGET
...
void *GameSession::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11GameSessionE.stringdata0))
